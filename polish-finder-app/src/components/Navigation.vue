        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <router-link
                            class="nav-link active apply-font"
                            aria-current="page"
                            to="/about"
                            >About
                        </router-link>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <router-link class="dropdown-item" to="/polishes"
                                    >Polishes</router-link
                                >
                            </li>
                        </ul>
                    </li>
                ...
                <div v-else>
                    <router-link to="/register" v-slot="{ register }"
                        ><button
                            class="button-54 btn-color-register mx-2"
                            type="button"
                            @click="register"
                        >
                            Register
                    ...
                    <router-link to="/login" v-slot="{ navigate }">
                        <button
                            class="button-54 btn-color-login mx-2"
                            type="button"
                            @click="navigate"
                        >
                            Sign In
