            ...
            <div v-else>
              <div class="">
                <div class="text-start">
                  ...
                  <p>The link may have expired or you are using an invalid token.</p>
                  <p>
                    Please check your email for the verification link and try again. If you have not
                    received it, you may need to request a new one.
                  </p>
                </div>

                <router-link to="/resend-verification" class="btn mb-3 w-25" id="colorful-button"
