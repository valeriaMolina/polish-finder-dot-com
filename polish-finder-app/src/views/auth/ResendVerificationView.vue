<template>
  <div class="background-gradient d-flex flex-column align-items-center px-3 py-5">
    <div class="pt-2">
      <div class="border shadow rounded px-1 py-4 verification-success" :hidden="!emailSubmitted">
        <div class="my-3 px-5 text-center"><h2>Email Verification Sent</h2></div>
        <div class="d-flex flex-column mb-3 mx-2">
          <p>
            If an account with that email exists, we've sent a new verification link. Please check
            your inbox and follow the instructions to verify your email address.
          </p>
          <p>
            It may take up to 10 minutes for the email to arrive. Be sure to check your spam or junk
